...
bool PauseState::onEnter() {
    ...
    auto menuButton = new Button({280,150},"menu_button",this->gameWindow->getTextureManager(),this->gameWindow->getInputHadler(),toMain/*[this]() { s_pauseToMain(); }*/);
    auto resumeButton = new Button({280,350},"resume_button",this->gameWindow->getTextureManager(),this->gameWindow->getInputHadler(),toResume/*[this]() { s_resumePlay(); }*/);
