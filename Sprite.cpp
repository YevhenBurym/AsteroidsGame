...
Sprite::Sprite(const char* pathToTexture, SDL_Renderer* renderer) {
    this->renderer = renderer;
    this->texture = nullptr;

    this->texture = IMG_LoadTexture(renderer, pathToTexture);
...
void Sprite::draw(int x, int y) {
    ...
    SDL_RenderCopy( this->renderer, this->texture, nullptr, &drawParams );
}
